 ...
 * 
 * @see com.source.plan.entity.Message
...
public class MessageDAO extends BaseHibernateDAO {
	...
	public static final String MESSAGE_IS_REPLY = "messageIsReply";
	...
	public Message findById(java.lang.String id) {
		...
		try {
			Message instance = (Message) getSession().get(
					"com.source.plan.entity.Message", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Message instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.source.plan.entity.Message")
	...
	public List findByMessageTime(Object messageTime) {
		return findByProperty(MESSAGE_TIME, messageTime);
	}
	...
	public List findByMessageIsReply(Object messageIsReply) {
		return findByProperty(MESSAGE_IS_REPLY, messageIsReply);
	}

...
<body>
	...
	<div class="answer-body">
		...
		<div style="margin-left: 30px;margin-top: 50px;">
			<h3>
				<img src="user/userimg/<%=answer.getAnswerUserImage()%>" width="50px"
					style="float: left; margin:5px;"><%=answer.getAnswerUsername()%><span
		...
		<a class="btn btn-info"
				href="confirmAdopt?AnswerID=<%=answer.getAnswerID()%>&QuestionID=<%=answer.getAnswerOfQuestion()%>&GiveUserID=<%=user.getUserId()%>&GetUserID=<%=answer.getAnswerUserID()%>"

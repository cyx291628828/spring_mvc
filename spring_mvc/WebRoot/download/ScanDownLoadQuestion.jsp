...
<body>
 ...
 %> </span>
			...
			<div class="collections"
				...
				</span> <span style="padding-right:0;">发布者：<font color="#27AE60"><%=q.getUser().getUserName()%></font>
					...
					<div class1="other">
						...
						<div class="answer-body">
							<div style="margin-left: 30px;margin-top: 50px;">
								<h3>
									<img src="user/userimg/<%=a.getUser().getUserImage()%>"
										width="50px" style="float: left; margin:5px;"><%=a.getUser().getUserName()%><span

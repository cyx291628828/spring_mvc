				...
				<table>
					...
					<%
						...
						for (Notice notice : pageInfo.getNotices()) {
							if (notice.getNoticeIsCheck().equals("0")) {
								i++;
					%>
					<tr>
						...
						<td><%=notice.getNoticeAriseTime()%></td>
						<td><a
							href="NoticeScan?QuestionID=<%=notice.getQuestion().getQuestionId()%>&NoticeID=<%=notice.getNoticeId()%>"
		...
		<div class="form-group panel panel-default">
			...
			<div style="margin-top: 0px;">
				<table>
					...
					<%
						for (Notice notice : pageInfo.getNotices()) {
						if (notice.getNoticeIsCheck().equals("1")) {
							j++;
					%>
					<tr>
						<td><span class="glyphicon glyphicon-envelope" style="margin-left: 10px;"></span>
